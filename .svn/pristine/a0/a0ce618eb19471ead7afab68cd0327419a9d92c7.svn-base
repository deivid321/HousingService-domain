...
import com.deivydas.voroneckis.rest.LocationService;
...
public class HousingFacade implements IHousingFacade {
    ...
    public void setHouseDatabase(IRoomDatabase houseDatabase){//TODO: Is it correct???
        this.houseDatabase = houseDatabase;
    }

    @Override
    public void addRoom(Room room) {
        Location location = locationService.getLocation(room.getStreet(), room.getHouseNumber());
        room.setCoordinates(location);
    ...
    public void updateStudent(Student student) {
        ...
        if (studentOld.getRoom() != null) {              //remove from old room
            roomOld = houseDatabase.getRoomById(studentOld.getRoom().getId());
            roomOld.unsettleStudent(studentOld);
        }
        if (student.getRoom() != null) {    //settle to new room
            roomNew = houseDatabase.getRoomById(student.getRoom().getId());
